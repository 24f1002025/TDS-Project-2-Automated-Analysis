...
"""
    ...
    def save_readme_to_eval(self):
        eval_folder = os.path.join(os.path.dirname(self.file_path), 'eval')
        os.makedirs(eval_folder, exist_ok=True)
        eval_readme_path = os.path.join(eval_folder, os.path.basename(self.file_path).replace('.csv', '_README.md'))
        try:
            shutil.copy(os.path.join(self.output_dir, 'README.md'), eval_readme_path)
